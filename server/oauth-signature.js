module.exports = {
	oauthSignature: (function () {
		'use strict';
		var CryptoJS = require("crypto-js");

		// const url = "https://stream.svc.7digital.net/stream/catalogue";
